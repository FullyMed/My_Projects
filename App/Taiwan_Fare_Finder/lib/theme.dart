...
/// Bundled font family. The variable TTF ships in `assets/fonts/` and is
/// declared in `pubspec.yaml` — no runtime download, no third-party origin.
...
class LightModeColors {
  ...
  static const lightBackground = Color(0xFFF6FAFB);
  static const lightSurfaceVariant = Color(0xFFE7F0F2);
  static const lightOnSurfaceVariant = Color(0xFF44474E);

  // Outline and shadow
  static const lightOutline = Color(0xFF74777F);
  static const lightShadow = Color(0xFF000000);
  static const lightInversePrimary = Color(0xFF2DD4BF);
}
...
class DarkModeColors {
  ...
  static const darkOnPrimary = Color(0xFF042F2E);
  ...
  static const darkSurfaceVariant = Color(0xFF1D2B2E);
...
/// Build text theme using the bundled Plus Jakarta Sans font family.
///
/// The `_fontFamily` string is a variable font; Flutter maps each
/// [FontWeight] onto its `wght` axis, so all weights come from one asset.
