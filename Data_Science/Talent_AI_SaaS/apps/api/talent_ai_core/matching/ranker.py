...
(src/talent_ai/matching/ranker.py). Storage-agnostic and tenant-agnostic by
construction: callers are responsible for only passing in one tenant's
candidates, since this class has no notion of tenancy itself.
"""
