"""Generate AI candidate insights with a single structured LLM call per
candidate: summary, strengths/weaknesses, missing qualifications, hiring
recommendation, and personalized interview questions -- combined into one
call (cheaper and more consistent than five separate calls).
...
from .llm_client import LLMUsage, parse_structured
...
) -> tuple[CandidateInsights, LLMUsage]:
